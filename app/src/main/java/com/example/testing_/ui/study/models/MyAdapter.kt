...
class MyAdapter(private val context: Context, private var dataList: List<DataClass>) : RecyclerView.Adapter<MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view: View = LayoutInflater.from(parent.context).inflate(R.layout.test_recycle, parent, false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.recCard.setOnClickListener {
            ...
            intent.putExtra("Image", dataList[holder.bindingAdapterPosition].dataImage)
            intent.putExtra("Description", dataList[holder.bindingAdapterPosition].dataDesc)
            intent.putExtra("Title", dataList[holder.bindingAdapterPosition].dataTitle)
            intent.putExtra("Priority", dataList[holder.bindingAdapterPosition].dataPriority)
